    ...
    <div class="mx-auto grid min-h-[calc(100vh-3rem)] max-w-6xl items-center gap-8 lg:grid-cols-[1fr_420px]">
        <section class="hidden lg:block">
            ...
            <div class="mt-8 grid max-w-xl gap-3">
                @foreach([
                    ['icon' => 'file-search', 'text' => 'Tanya materi berdasarkan isi dokumen yang kamu unggah.'],
                    ['icon' => 'notebook-tabs', 'text' => 'Buat ringkasan, soal latihan, dan kartu belajar otomatis.'],
