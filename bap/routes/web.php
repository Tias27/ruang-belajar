...
Route::middleware(['auth', 'role:mahasiswa'])->group(function () {
    ...
    Route::post('documents/{document}/chat', [ChatController::class, 'create'])->name('chat.create');
    Route::post('folders/{folder}/chat', [ChatController::class, 'createFolder'])->name('folders.chat.create');
