        ...
        <div class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm lg:col-span-2 flex flex-col justify-between">
            ...
            <div class="mt-4 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4 pt-4 border-t border-slate-100">
                    ...
                    <div class="space-y-1">
                        <span class="text-xs text-slate-500 uppercase font-semibold">Biaya Operasional AI</span>
                        <span class="block text-lg font-bold text-slate-950">Rp 194.500</span>
                        <span class="text-xs text-slate-400">Estimasi penggunaan API</span>
                    </div>
                </div>
            </div>
