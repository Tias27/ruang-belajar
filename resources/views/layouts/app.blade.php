...
<body class="min-h-screen bg-[#f8fbff] text-slate-900 antialiased" x-data="{mobileNav:false}">
    ...
    @endauth
    <main class="@auth lg:ml-64 @endauth flex flex-col h-[calc(100vh-4rem)]">
        <div class="{{ request()->routeIs('chat.show') ? 'flex flex-col flex-1 h-full' : 'mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8' }}">
            @if(session('status'))
